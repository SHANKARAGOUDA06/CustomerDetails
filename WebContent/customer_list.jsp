...
<table class="table">
  <thead>
	...
	<c:forEach var="i" items="${al}">
		<tr>
			<td><c:out value="${i.cid}"></c:out></td>
			<td><c:out value="${i.name}"></c:out></td>
			<td><c:out value="${i.email}"></c:out></td>
			<td><c:out value="${i.mobile}"></c:out></td>
					
					<!-- --Query String -->
			<td><a href="editForm?cid=<c:out value="${i.cid}"></c:out>">Edit</a> &nbsp;&nbsp; <a href="delete?cid=<c:out value="${i.cid}"></c:out>">delete</a></td>
		</tr>
	</c:forEach>
